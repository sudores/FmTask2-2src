...
I express thanks to the original author for publishing app under MIT license.
Here's the source code of original app
https://github.com/schadokar/go-to-do-app.git
